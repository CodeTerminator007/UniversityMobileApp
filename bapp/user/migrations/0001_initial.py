    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cnic', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message="Cnic must be entered in the format: '11111-1111111-1'. Cnic must be entered with dashes.", regex='^[0-9]{5}-[0-9]{7}-[0-9]{1}$')])),
